...
export const data: {
    ...
    request: [
        ...
        },
        {
            ...
            contentType: null,
            method: RequestSetting_Method.POST,
            name: 'kalispelltoyota certified',
            postData:
