        ...
        entryPoints: [
            {
                ...
                url: 'https://www.cricksmaroochydorevw.com.au/stock/sitemap',
                requiredParams: null,
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: 'el="canonical"\\s*[^-]+-[^-]+-[^-]+-[^-]+-[^-]+-(?<stock_type>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: "Engine:[^>]+>[^>]+>(?<engine_description>[^\\s]+)",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: "<h2>Comments<\/h2>\\s*<p>(?<description>[\\s\\S]*?(?=<h2>))",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'product:price:amount" content="(?<price>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'embla__slide__inner">\\s*<a\\s*href="(?<images>[^"]+)',
                        active: true,
                    },
                ],
            },
