    ...
    config: {
        ...
        entryPoints: [
            ...
            },   
            {
                ...
                url: 'https://www.gphonda.ca/used/dealer/Bannister+GP+Honda',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '(?:<span itemprop="price"[^>]+>|<span id="final-price">)(?<price>[^<]+)',
                        active: true,
                    },
                ],
            },
