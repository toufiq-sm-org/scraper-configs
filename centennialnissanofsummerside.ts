        ...
        entryPoints: [
            {
                ...
                url: 'https://www.centennialnissanofsummerside.com/en/new-inventory?limit=200',
                requiredParams: null,
            ...
            },   
            {
                ...
                url: 'https://www.centennialnissanofsummerside.com/en/used-inventory?limit=200',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: '<article class="inventory-list-layout-wrapper', 
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '<a class="inventory-list-layout__preview-name" href="(?<url>[^"]+)"\\s*title="(?<title>(?<year>[0-9]{4})\\s*(?<make>[^\\s]+)\\s*(?<model>[^\\s]*))',
                        active: true,
                    },
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 2,
                        value: 'https://www.centennialnissanofsummerside.com',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: 'itemprop="price" content=[^>]+>(?<price>\\$[0-9,]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: 'Inventory #:<\\/div>\\s*[^>]+>(?<stock_number>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Drivetrain:<\\/div>\\s*[^>]+>(?<drivetrain>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Transmission:<\\/div>\\s*[^>]+>(?<transmission>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Ext.\\s*Color:<\\/div>\\s*[^>]+>(?<exterior_color>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: "Int.\\s*color:<\\/div>\\s*[^>]+>(?<interior_color>[^<]+)",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Bodystyle:<\\/div>\\s*[^>]+>(?<body_style>[^<]+)',
                        active: true,
                    },
                ],
            },
