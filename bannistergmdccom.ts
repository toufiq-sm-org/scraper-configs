        ...
        entryPoints: [
            {
                ...
                url: 'https://www.bannistergmdc.com/new/',
                requiredParams: null,
            ...
            },   
            {
                ...
                url: 'https://www.bannistergmdc.com/used/dealer/Bannister+GM+Dawson+Creek',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: '<div class="col-xs-12 col-sm-12 col-md-12', 
                        active: true,
                    },
                ],
            },
            {
                ...
                extractors: [
                    ...
                    },
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 2,
                        value: 'https://www.bannistergmdc.com',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: "itemprop='releaseDate' notranslate>(?<year>[0-9]{4})",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: "itemprop='manufacturer' notranslate><var>(?<make>[^\\<]+)",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: "itemprop='model' notranslate><var>(?<model>[^\\<]+)",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: 'itemprop="mileageFromOdometer"[^>]*>(?<odometer>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: 'itemprop="driveWheelConfiguration">(?<drivetrain>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: 'onerror="imgError\\(this\);"\\s*(?:data-src|src)="(?<images>[^"]+)"',
                        active: true,
                    },
                ],
            },
