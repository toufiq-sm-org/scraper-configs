        ...
        entryPoints: [
            {
                ...
                url: 'https://www.bannisterkiapenticton.com/new/',
                requiredParams: null,
            ...
            },   
            {
                ...
                url: 'https://www.bannisterkiapenticton.com/used/dealer/Bannister+Kia+Penticton',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
            ...
            },
            {
                ...
                extractors: [
                    ...
                    },
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 2,
                        value: 'https://www.bannisterkiapenticton.com',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: 'Mileage[^>][^"]+"mileage[^>]+>[^>]+>[^>]+>(?<odometer>[^<]+)',
                        active: true,
                    },
                ],
            },
