        ...
        entryPoints: [
            {
                ...
                url: 'https://www.inamotors.com/new/',
                requiredParams: null,
            ...
            },   
            {
                ...
                url: 'https://www.inamotors.com/used/',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Ina Motors Finance Incentive Price[^>]+>[^>]+>[^>]+>\\s*<span\\s*itemprop="price"\\s*content="(?<price>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'temprop="fuelType">(?<fuel_type>[^<]+)',
                        active: true,
                    },
                ],
            },
