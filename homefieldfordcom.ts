        ...
        entryPoints: [  
            {
                ...
                url: 'https://www.homefieldford.com/new/inventory/search.html',
                requiredParams: null,
            ...
            },   
            {
                ...
                url: 'https://www.homefieldford.com/used/inventory/search.html',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
            ...
            },
            {
                ...
                extractors: [
                    ...
                    },
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 2,
                        value: 'https://www.homefieldford.com',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '<a\\s*href="(?<url>[^"]+)"\\s*title="(?<year>[^\\s*]+)\s*(?<make>[^\\s*]+)\\s*(?<model>[^\\s*]+)',
                        active: true,
                    },
                ],
            },
