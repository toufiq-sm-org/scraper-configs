...
export const data: {
    ...
    request: [
        ...
        },
        {
            ...
            contentType: null,
            method: RequestSetting_Method.POST,
            name: 'mercedes_benz_heritagevalleyca used',
            postData:
