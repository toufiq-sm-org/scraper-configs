        ...
        entryPoints: [
            {
                ...
                url: 'https://www.cambrianford.com/new/inventory/search.html?filterid=q0-500',
                requiredParams: null,
            ...
            },   
            {
                ...
                url: 'https://www.cambrianford.com/used/search.html?filterid=q0-500',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
            ...
            },
            {
                ...
                extractors: [
                    ...
                    },
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 2,
                        value: 'https://www.cambrianford.com',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: "class=\\divSpan divSpan12 carDescription elIsLoadable\\><span [^>]+><span [^>]+>(?<odometer>[0-9 ,]+)\\s*KM",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: "'currentStatus' value='(?<stock_type>[^']+)",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: "expressstocknumber' value='(?<stock_number>[^']+)",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'rel="slider-lightbox[^"]+" href="(?<images>[^"]+)',
                        active: true,
                    },
                ],
            },
