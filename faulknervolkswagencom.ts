    ...
    config: {
        ...
        entryPoints: [
            { 
                ...
                url: 'https://www.faulknervolkswagen.com/sitemap-inventory-sincro.xml',
                requiredParams: null,
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: "Stock\s*#[^>]+>[^>]+>(?<stock_number>[^<]+)<\\/span",
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'itemprop="vehicleEngine"[^>]+>\\s*<[^>]+>\\s*<[^>]+>(?<engine_description>[^<]+)',
                        active: true,
                    },
                ],
            },
