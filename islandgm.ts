                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: 'swiper-slide">\\s*<img data-src="(?<img_url>[^"]+)"\\s*alt="',
                        active: true,
                    },
                ],
            },
