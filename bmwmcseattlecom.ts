        ...
        entryPoints: [
            {
                ...
                url: 'https://www.bmwmcseattle.com/--inventory?condition=new&pg=1',
                requiredParams: null,
            ...
            },   
            {
                ...
                url: 'https://www.bmwmcseattle.com/--inventory?condition=pre-owned&pg=1',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '<a class="vehicle-heading__link" href="(?<url>[^"]+)"',
                        active: true,
                    },
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 2,
                        value: 'https://www.bmwmcseattle.com',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: 'v7list-pagination__page">Page\\s*(?<next>[^\\s]+)\\sof[^>]+>\\s*[^>]+>[^>]+>[^"]+"[^"]+" aria-label="Next Page of Results" >',
                        active: true,
                    },
                    {
                        type: Extractor_Type.PREPEND_STRING,
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: 'vehicle-heading__year">(?<year>[0-9]{4})',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: 'class="vehicle-price__price ">\\s*(?<price>[^\\s]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Odometer<\\/label>\\s*[^>]+>(?<odometer>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: 'Vehicle Type[^>]+>[^>]+>\\s*(?<body_style>[^<]+)',
                        active: true,
                    },
                ],
            },
