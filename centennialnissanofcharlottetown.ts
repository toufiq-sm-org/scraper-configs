        ...
        entryPoints: [
            {
                ...
                url: 'https://www.centennialnissanofcharlottetown.com/en/new-inventory?filterid=q0-500',
                requiredParams: null,
            ...
            },   
            {
                ...
                url: 'https://www.centennialnissanofcharlottetown.com/en/used-inventory?filterid=q0-500',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: 'class="inventory-list-layout-wrapper', 
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '<a class="inventory-list-layout__preview-name"\\s*href="(?<url>[^"]+)"\\s*title="(?<year>[^\\s*]+)\\s*(?<make>[^\\s*]+)\\s*(?<model>[^\\s*]+)',
                        active: true,
                    },
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 2,
                        value: 'https://www.centennialnissanofcharlottetown.com',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '<link rel="next" href="(?<next_page>[^"]+)',
                        active: true,
                    },
                    {
                        type: Extractor_Type.PREPEND_STRING,
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Ext. Color:[^>]+>[^>]+>(?<exterior_color>[^<]+)',
                        active: true,
                    },
                ],
            },
