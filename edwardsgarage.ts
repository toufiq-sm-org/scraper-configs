    ...
    config: {
        ...
        entryPoints: [
            { 
                ...
                url: 'https://www.edwardsgarage.com/inventory_pages-sitemap.xml',
                requiredParams: null,
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: 'itemCondition":"(?<stock_type>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'vehicle-title--year">\\s*(?<year>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'class="notranslate vehicle-title--make\\s*">\\s*(?<make>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'class="notranslate vehicle-title--model\\s*">\\s*(?<model>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'class="notranslate vehicle-title--trim\\s*">\\s*(?<trim>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'name="description" content="[^\\$]+\\$(?<price>[^.]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'data-vehicle="engdescription" >\\s*(?<engine_description>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'data-vehicle="transdescription" >\\s*(?<transmission>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'data-vehicle="extcolor" >\\s*(?<exterior_color>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'data-vehicle="intcolor" >(?<interior_color>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'data-vehicle="miles"\\s*[^>]+>(?<odometer>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'data-vehicle="standardbody" >\\s*(?<body_style>[^<]+)',
                        active: true,
                    },
                ],
            },
