                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: "class='swiper-slide'>\\s*[^>]+>\\s*<img[^']+'[^']+'[^']+'(?<images>[^']+)",
                        active: true,
                    },
                ],
            },
