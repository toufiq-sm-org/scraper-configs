    ...
    config: {
        ...
        entryPoints: [
            { 
                ...
                url: 'http://www.fieldofrvdreams.com/sitemap.xml',
                requiredParams: null,
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: 'product\\/(?<stock_type>[^-]+)-[0-9]{4}',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: '<td class="SpecLabelContainer">Interior Color[^>]+>\\s*[^>]+>\\s*(?<interior_color>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: '<a title="Click to enlarge" href="(?<images>[^"]+)" data',
                        active: true,
                    },
                ],
            },
