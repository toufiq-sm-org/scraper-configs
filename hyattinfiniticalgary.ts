...
export const data: {
    ...
    request: [
        ...
        },
        {
            ...
            contentType: null,
            method: RequestSetting_Method.POST,
            name: 'hyattinfiniticalgary used',
            postData:
