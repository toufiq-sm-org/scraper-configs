    ...
    config: {
        ...
        entryPoints: [
            { 
                ...
                url: 'https://cansoford.ca/inventory-sitemap.xml',
                requiredParams: null,
                productType: ProductType.CAR,
                type: EntryPoint_Type.SITE_MAP,
                sitemapPdpUrlValidator: '\\/inventory\\/[0-9]{4}-[^\\/]+\\/[0-9]{7,8}',
            },
        ],
        fields: [
            {
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: '<title>(?<stock_type>[^\\s*]+)\\s*(?<year>[^\\s*]+)\\s*(?<make>[^\\s*]+)\\s*(?<model>[^\\s*]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'itemprop="releaseDate">(?<year>[^<]+)<',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'itemprop="vehicleConfiguration">(?<trim>[^<]+)<',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Body Style[^>]+>[^>]+>(?<body_style>[^<]+)<\\/h5>',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Transmission[^>]+>[^>]+>(?<transmission>[^<]+)<\\/h5>',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Exterior Colour[^>]+>[^>]+>(?<exterior_color>[^<]+)<\\/h5>',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Engine[^>]+>[^>]+>(?<engine_description>[^<]+)<\\/h5>',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Photo5" data-lazy-src="(?<images>[^"]+)"',
                        active: true,
                    },
                ],
            },
