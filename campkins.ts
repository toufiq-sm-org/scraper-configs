        ...
        entryPoints: [
            {
                ...
                url: 'https://www.campkins.com/rv-inventory/new/',
                requiredParams: null,
            ...
            },   
            {
                ...
                url: 'https://www.campkins.com/rv-inventory/used/',
                requiredParams: null,
                type: EntryPoint_Type.HTML,
                productType: ProductType.CAR,
            },   
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: '<div class="col-xxs-12 col-xs-6 col-lg-4 tile-wrapper">', 
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '<div class="featured-image-wrap">\\s*<a href="(?<url>[^"]+)" title="View Details',
                        active: true,
                    },
                    {
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '<a href="(?<next_page>[^"]+)" id="next-page" title="Next Page">',
                        active: true,
                    },
                    {
                        type: Extractor_Type.PREPEND_STRING,
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.LIST,
                        order: 1,
                        value: '(?:Web Price|Special Price|Clearance Price)<\\/span>\\s*<span class="[^>]+">(?<price>\\$[0-9,]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'Stock No.<\\/td>\\s*<td>(?<stock_number>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'RV Type<\\/td>\\s*<td>(?<body_style>[^<]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: '<div class="item">\\s*<img src="[^"]+"\\s*data-src="(?<images>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: '<td>Status<\\/td>\\s*<td>(?<stock_type>[^<]+)',
                        active: true,
                    },
                    {
