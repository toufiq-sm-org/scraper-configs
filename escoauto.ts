    ...
    config: {
        ...
        entryPoints: [
            { 
                ...
                url: 'https://www.escoauto.com/sitemap.xml',
                requiredParams: null,
                productType: ProductType.CAR,
                type: EntryPoint_Type.SITE_MAP,
                sitemapPdpUrlValidator: '\\/detail\\/[0-9]{4}',
            },
        ],
        fields: [
            {
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: 'product:condition" content="(?<stock_type>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'itemprop="sku"\\s*content="(?<stock_number>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'itemprop="productID"\\s*content="(?<vin>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'itemprop="releaseDate"\\s*content="(?<year>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'itemscope>\\s*<meta\\s*itemprop="name"\\s*content="(?<make>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'itemprop="model"\\s*content="(?<model>[^"]+)',
                        active: true,
                    },
                ],
            },
                ...
                extractors: [
                    {
                        ...
                        pageType: PageType.PDP,
                        order: 1,
                        value: 'thumbnail ds-detail-thumb">\\s*<img.*data-src="(?<images>[^"]+)',
                        active: true,
                    },
                ],
            },
