...
export const data: {
    ...
    request: [
        ...
        },
        {
            ...
            contentType: null,
            method: RequestSetting_Method.POST,
            name: 'genesisoflagunaniguelcom used',
            postData:
                ...
                extractors: [
                    {
                        ...
                        order: 1,
                        value: "swiper-lazy'\\s*data-src='(?<images>[^']+)'",
                        active: true,
                    },
                ],
            },
